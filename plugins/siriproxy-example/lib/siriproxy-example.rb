...
class SiriProxy::Plugin::Example < SiriProxy::Plugin
  ...
  listen_for /siri proxy test question/i do
    ...
    listen_for /computer track/i do
    say `./playing.py`
    request_completed #always complete your request! Otherwise the phone will "spin" at the user!
  end

    listen_for /computer who are you/i do
    say "Logged in as: " + `sudo -u grant whoami`
    request_completed #always complete your request! Otherwise the phone will "spin" at the user!
  end

    listen_for /computer play/i do
    say `./play.py`
    request_completed #always complete your request! Otherwise the phone will "spin" at the user!
  end

    listen_for /computer/i do
    say `./commands.py`
